...
export default function Question6({ onSelect }: Question6Props) {
  const options = [
    'Não, me sinto com sobrepeso',
    'Sim, mas quero melhorar',
    'Não, quero me sentir mais saudável'
  ];
        ...
        <main className="flex-1">
          <div className="max-w-3xl mx-auto">
            ...
            <h2 className="text-2xl md:text-4xl font-serif font-bold text-gray-900 mb-3">
              Você realmente está feliz com sua aparência?
            </h2>
            <p className="text-base md:text-lg text-gray-700 mb-6">
              Seja honesto, isso faz diferença no seu resultado
            </p>
